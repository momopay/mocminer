...
int main(int argc, char *argv[])
{
	...
	printf("*** mocminer " PACKAGE_VERSION " for nVidia GPUs release by MomoCash ***\n");
	if (!opt_quiet) {
		...
		printf("  Include some kernels from alexis78, djm34, djEzo, tsiv and krnlx and tpruvot.\n\n");
		printf("Official Website: https://www.momocash.org/\n\n");
	}
